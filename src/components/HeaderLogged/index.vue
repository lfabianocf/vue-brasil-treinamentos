  ...
  <div class="flex items-center justify-between w-4/5 max-w-6xl py-10">
    ...
    <div class="flex"  >
      <ul class="flex list-none">
        ...
        class="px-6 py-2 font-bold text-white rounded-full cursor-pointer focus:ouline-none">
        Credenciais</li>
        ...
        <li
        @click="handleLogout"
        class="px-6 py-2 font-bold bg-white rounded-full cursor-pointer focus:ouline-none"
         >
        {{ logoutLabel }}
        </li>
      </ul>
